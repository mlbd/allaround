	...
	<div class="<?php echo $cc_show === 'yes' ? 'xoo-ml-has-cc' : ''; ?>">
		...
		<div class="xoo-ml-regphin">
			...
			<div class="alarnd--xoo-otp-wrap">
				...
				<div class="xoo-ml-otp-input-cont-wrap">
				...
				<div class="xoo-ml-otp-input-cont-wrap xoo-ml-otp-input-cont-main">
					...
					for ( $i= 0; $i < $phone_number_lengh; $i++ ):
						...
						<?php if ($is_last): ?>
							<input type="tel" maxlength="1" autocomplete="off" name="xoo-ml-reg-phone[]" placeholder="<?php echo !empty($phone) ? esc_attr($lastTwoDigits[1]) : 'x'; ?>" value="<?php echo !empty($phone) ? esc_attr($lastTwoDigits[1]) : ''; ?>" disabled="disabled" class="alarnd--otp-input xoo-ml-phone-obj alrn-pre-filled-digits">
						<?php elseif ($is_second_to_last): ?>
							<input type="tel" maxlength="1" autocomplete="off" name="xoo-ml-reg-phone[]" placeholder="<?php echo !empty($phone) ? esc_attr($lastTwoDigits[0]) : 'x'; ?>" value="<?php echo !empty($phone) ? esc_attr($lastTwoDigits[0]) : ''; ?>" disabled="disabled" class="alarnd--otp-input xoo-ml-phone-obj alrn-pre-filled-digits">
						<?php else : ?>
							<input type="tel" maxlength="1" autocomplete="off" name="xoo-ml-reg-phone[]" placeholder="x" class="alarnd--otp-input xoo-ml-phone-obj">
						<?php endif; ?>
